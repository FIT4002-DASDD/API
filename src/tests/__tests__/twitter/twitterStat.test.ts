...
describe("GET /twitter/stats", () => {
  test("GET /twitter/stats/bot-alignment - Get alignment stats for bots #API-21", async (done) => {
  ...
  test("GET /twitter/stats/category - Get category stats for bots #API-22", async (done) => {
    const res = await supertest(app)
  ...
  test("GET /twitter/stats/category-bot - Get category distribution based on bots #API-23", async (done) => {
    const res = await supertest(app)
      .get("/twitter/stats/category-bot")
      .expect("Content-Type", /json/)
      .expect(200);
